...
where H and A are matrices and A^T is the transpose of A. Here, H may or may not
be symmetric and may or may not have stronger properties, such as positive
...
more information on general Krylov methods and projected Krylov methods, see the
references below.
...
The following methods are on the way

          +------------------------------+----------+----------+
          | Method                       | Module   | Class    |
          +==============================+==========+==========+
          | Projected TFQMR              | ptfqmr   | Ptfqmr   |
          +------------------------------+----------+----------+

References
----------

.. [Kel95] C. T. Kelley, *Iterative Methods for Linear and Nonlinear Equations*,
